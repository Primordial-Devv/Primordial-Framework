...
if EnableDebug then
    AddEventHandler("primordial_core:playerPedChanged", function(netId)
        PL.Print.Log(4, "primordial_core:playerPedChanged", netId)
    end)

    AddEventHandler("primordial_core:enteringVehicle", function(vehicle, plate, seat, netId)
        PL.Print.Log(4, "primordial_core:enteringVehicle", "vehicle", vehicle, "plate", plate, "seat", seat, "netId", netId)
    end)

    AddEventHandler("primordial_core:enteringVehicleAborted", function()
        PL.Print.Log(4, "primordial_core:enteringVehicleAborted")
    end)

    AddEventHandler("primordial_core:enteredVehicle", function(vehicle, plate, seat, displayName, netId)
        PL.Print.Log(4, "primordial_core:enteredVehicle", "vehicle", vehicle, "plate", plate, "seat", seat, "displayName", displayName, "netId", netId)
    end)

    AddEventHandler("primordial_core:exitedVehicle", function(vehicle, plate, seat, displayName, netId)
        PL.Print.Log(4, "primordial_core:exitedVehicle", "vehicle", vehicle, "plate", plate, "seat", seat, "displayName", displayName, "netId", netId)
    end)
end
