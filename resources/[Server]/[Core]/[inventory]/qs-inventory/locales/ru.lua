Locales["ru"] = {
    ...
    ["INVENTORY_TRADE_NOTIFICATION_EMPTY_INPUT"] = 'Введите число больше 0; не может быть пустым',
        -- DrawTexts
    ["INVENTORY_TEXT_CRAFT"] = '[E] - Крафт',
    ["INVENTORY_TEXT_SELLING"] = '[Е] - Покупатель',
    ["INVENTORY_TEXT_REPAIR_NOT_AVAILABLE"] = 'В данный момент ремонтная мастерская недоступна',
    ...
    ["INVENTORY_TEXT_THROW_ITEM_BUTTON"] = 'Нажмите ~INPUT_CONTEXT~, чтобы бросить элемент.\nНажмите ~INPUT_CONTEXT_SECONDARY~, чтобы отменить.',
