Locales["zh-TW"] = {
    ...
    ["INVENTORY_NOTIFICATION_INVENTORY_IN_USE"] = '庫存正被其他玩家使用！',
    ...
    ["INVENTORY_NOTIFICATION_MONEY_NO_ITEM"] = '無法使用此命令給予金錢；使用適當的命令',
    ...
    ["INVENTORY_TRADE_NOTIFICATION_EMPTY_INPUT"] = '輸入大於0的數字；不能為空',
        -- DrawTexts
    ...
    ["INVENTORY_TEXT_THROW_ITEM_BUTTON"] = '按 ~INPUT_CONTEXT~ 丟出物品\n按 ~INPUT_CONTEXT_SECONDARY~ 取消',
