Locales["nl"] = {
    ...
    ["INVENTORY_NOTIFICATION_INVENTORY_FULL"] = 'De inventaris was vol, er werden voorwerpen op de grond gedropt',
    ...
    ["INVENTORY_NOTIFICATION_INVENTORY_IN_USE"] = 'De inventaris wordt gebruikt door een andere speler!',
    ...
    ["INVENTORY_TRADE_NOTIFICATION_EMPTY_INPUT"] = 'Voer een getal groter dan 0 in; kan niet leeg zijn',
        -- DrawTexts
    ...
    ["INVENTORY_TEXT_THROW_ITEM_BUTTON"] = 'Druk op ~INPUT_CONTEXT~ om het item te gooien\nDruk op ~INPUT_CONTEXT_SECONDARY~ om te annuleren',
