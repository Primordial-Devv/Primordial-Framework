Locales["no"] = {
    ...
    ["INVENTORY_NOTIFICATION_INVENTORY_IN_USE"] = 'Inventaret blir brukt av en annen spiller!',
    ...
    ["INVENTORY_TRADE_NOTIFICATION_EMPTY_INPUT"] = 'Skriv inn et tall større enn 0; kan ikke være tom',
        -- DrawTexts
    ...
    ["INVENTORY_TEXT_THROW_ITEM_BUTTON"] = 'Trykk ~INPUT_CONTEXT~ for å kaste elementet\nTrykk ~INPUT_CONTEXT_SECONDARY~ for å avbryte',
