Locales["pt"] = {
    ...
    ["INVENTORY_NOTIFICATION_INVENTORY_IN_USE"] = 'O inventário está sendo usado por outro jogador!',
    ...
    ["INVENTORY_TRADE_NOTIFICATION_EMPTY_INPUT"] = 'Insira um número maior que 0; não pode estar vazio',
        -- DrawTexts
    ...
    ["INVENTORY_TEXT_THROW_ITEM_BUTTON"] = 'Pressione ~INPUT_CONTEXT~ para lançar o item\nPressione ~INPUT_CONTEXT_SECONDARY~ para cancelar',
