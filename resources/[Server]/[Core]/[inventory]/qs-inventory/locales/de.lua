Locales["de"] = {
    ...
    ["INVENTORY_NOTIFICATION_INVENTORY_IN_USE"] = 'Das Inventar wird von einem anderen Spieler verwendet!',
    ...
    ["INVENTORY_TRADE_NOTIFICATION_EMPTY_INPUT"] = 'Geben Sie eine Zahl größer als 0 ein; darf nicht leer sein',
        -- DrawTexts
    ...
    ["INVENTORY_TEXT_THROW_ITEM_BUTTON"] = 'Drücken Sie ~INPUT_CONTEXT~, um den Gegenstand zu werfen.\nDrücken Sie ~INPUT_CONTEXT_SECONDARY~, um abzubrechen',
