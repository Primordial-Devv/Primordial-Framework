Locales["fa"] = {
    ...
    ["INVENTORY_NUI_VENDING"] = 'دستگاه فروش خودکار',
    ...
    ["INVENTORY_NOTIFICATION_GIVE_ITEM"] = 'شما داده اید',
    ...
    ["INVENTORY_NOTIFICATION_INVENTORY_IN_USE"] = 'موجودی توسط بازیکن دیگری استفاده می شود!',
    ...
    ["INVENTORY_TRADE_NOTIFICATION_EMPTY_INPUT"] = 'عددی بزرگتر از 0 وارد کنید؛ نمی تواند خالی باشد',
        -- DrawTexts
    ...
    ["INVENTORY_TEXT_REPAIR_TAKE"] = '[E] - سلاح را بازیابی کنید',
    ["INVENTORY_TEXT_REPAIR_PRICE"] = '[E] سلاح تعمیر، €',
    ["INVENTORY_TEXT_REPAIR_NO_WEAPON"] = 'شما سلاحی در دست ندارید',
    ["INVENTORY_TEXT_THROW_ITEM_BUTTON"] = 'برای پرتاب مورد، ~INPUT_CONTEXT~ را فشار دهید\nبرای لغو، ~INPUT_CONTEXT_SECONDARY~ را فشار دهید',
    ["INVENTORY_TEXT_PICKUP_ITEM"] = '[E] - مورد را بردارید',
        -- Progressbar
