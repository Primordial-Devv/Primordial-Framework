Locales["en"] = {
    ...
    ["INVENTORY_NOTIFICATION_INVENTORY_IN_USE"] = 'The inventory is being used by another player!',
    ...
    ["INVENTORY_TRADE_NOTIFICATION_EMPTY_INPUT"] = 'Enter a number greater than 0; cannot be empty',
        -- DrawTexts
