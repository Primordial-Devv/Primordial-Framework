Locales["sl"] = {
    ...
    ["INVENTORY_NOTIFICATION_NO_AMOUNT"] = 'Izberite količino 0 ali več',
    ...
    ["INVENTORY_NOTIFICATION_GLOVEBOX_BLOCKED"] = 'Ne morete dostopati do sovoznikovega predala, ki ni vaš',
    ...
    ["INVENTORY_TRADE_NOTIFICATION_EMPTY_INPUT"] = 'Vnesite število, večje od 0; ne more biti prazno',
        -- DrawTexts
