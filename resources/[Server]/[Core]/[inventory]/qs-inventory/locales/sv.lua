Locales["sv"] = {
    ...
    ["INVENTORY_NUI_LABEL_SET_TINT_PLACEHOLDER"] = 'Ange en webbadress för din nyans...',
    ...
    ["INVENTORY_NOTIFICATION_INVENTORY_IN_USE"] = 'Inventeringen används av en annan spelare!',
    ...
    ["INVENTORY_NOTIFICATION_EXPIRED_ITEM"] = 'Kan inte använda en utgången eller använd vara...',
    ...
    ["INVENTORY_NOTIFICATION_CLOTHING_VEHICLE"] = 'Kan inte öppna klädmenyn i ett fordon',
    ...
    ["INVENTORY_TRADE_NOTIFICATION_EMPTY_INPUT"] = 'Ange ett tal större än 0; kan inte vara tom',
        -- DrawTexts
    ...
    ["INVENTORY_TEXT_THROW_ITEM_BUTTON"] = 'Tryck på ~INPUT_CONTEXT~ för att kasta objektet\nTryck på ~INPUT_CONTEXT_SECONDARY~ för att avbryta',
