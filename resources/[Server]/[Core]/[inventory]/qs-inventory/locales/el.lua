Locales["el"] = {
    ...
    ["INVENTORY_NOTIFICATION_MISSING_ITEMS"] = 'Δεν έχετε τα απαραίτητα στοιχεία...',
    ...
    ["INVENTORY_NOTIFICATION_INVENTORY_IN_USE"] = 'Το απόθεμα χρησιμοποιείται από άλλο παίκτη!',
    ...
    ["INVENTORY_NOTIFICATION_SPAM"] = 'Σταμάτα να προσπαθείς. δεν θα λειτουργήσει...',
    ...
    ["INVENTORY_TRADE_NOTIFICATION_EMPTY_INPUT"] = 'Εισαγάγετε έναν αριθμό μεγαλύτερο από 0. δεν μπορεί να είναι κενό',
        -- DrawTexts
    ...
    ["INVENTORY_TEXT_THROW_ITEM_BUTTON"] = 'Πατήστε ~INPUT_CONTEXT~ για να πετάξετε το αντικείμενο\nΠατήστε ~INPUT_CONTEXT_SECONDARY~ για ακύρωση',
