Locales["ja"] = {
    ...
    ["INVENTORY_NOTIFICATION_SELLING_NOT_ITEM"] = 'その項目は存在しません',
    ...
    ["INVENTORY_NOTIFICATION_INVENTORY_IN_USE"] = 'インベントリは他のプレイヤーによって使用されています。',
    ...
    ["INVENTORY_TRADE_NOTIFICATION_EMPTY_INPUT"] = '0 より大きい数値を入力します。空にすることはできません',
        -- DrawTexts
    ...
    ["INVENTORY_TEXT_THROW_ITEM_BUTTON"] = '~INPUT_CONTEXT~ を押してアイテムを投げます\n~INPUT_CONTEXT_SECONDARY~ を押してキャンセルします',
