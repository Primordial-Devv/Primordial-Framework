Translations = {
    ...
    debug_sPlayer_get_first_name = "Returns Your First Name",
    debug_sPlayer_get_last_name = "Returns Your Last Name",
    debug_sPlayer_get_full_name = "Returns Your Full Name",
    debug_sPlayer_get_sex = "Returns Your Sex",
    debug_sPlayer_get_dob = "Returns Your DOB",
    debug_sPlayer_get_height = "Returns Your Height",
    error_debug_sPlayer_get_first_name = "There was an issue while obtaining your first name.",
    error_debug_sPlayer_get_last_name = "There was an issue while obtaining your last name.",
    error_debug_sPlayer_get_full_name = "There was an issue while obtaining your full name.",
    error_debug_sPlayer_get_sex = "There was an issue while obtaining your sex.",
    error_debug_sPlayer_get_dob = "There was an issue while obtaining your date of birth.",
    error_debug_sPlayer_get_height = "There was an issue while obtaining your height.",
    return_debug_sPlayer_get_first_name = "First Name: %s",
    return_debug_sPlayer_get_last_name = "Last Name: %s",
    return_debug_sPlayer_get_full_name = "Name: %s",
    return_debug_sPlayer_get_sex = "Sex: %s",
    return_debug_sPlayer_get_dob = "DOB: %s",
    return_debug_sPlayer_get_height = "Height: %s Inches",
